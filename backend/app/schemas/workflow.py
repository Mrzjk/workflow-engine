...
class ConditionIRSchema(BaseModel): expression: str; branch: str|None=None
class EdgeSchema(BaseModel): id: str; source: str; target: str; source_handle: str|None=None; target_handle: str|None=None; condition: ConditionIRSchema|None=None
...
class WorkflowSchema(BaseModel): version: str="1.0"; metadata: dict=Field(default_factory=dict); variables: dict=Field(default_factory=dict); nodes: list[BaseNode]; edges: list[EdgeSchema]
class WorkflowCreate(BaseModel): agent_id: str|None=None; name: str; description: str|None=None; graph: WorkflowSchema
